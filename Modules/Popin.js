...
/*global $body, CLICK_EVENT_NAME, template, PopinAccessibility, defaultOptions, Background */

Popin = function (userOptions = {}, $popin) {
    let loading,
        loaderOpened,
        popinOpened,
        $loader,
...
/*global defaultOptions, Background, $body, CLICK_EVENT_NAME, Popin, toggleTabIndex */

// eslint-disable-next-line no-undef
PopinController = function (userOptions = {}, $popin) {
    let options,
        selectors,
        background,
        popin;
